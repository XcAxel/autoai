...
import com.autoai.wedata.kittx.uds.log.bean.pbv26.LogDataBean;
import com.autoai.wedata.kittx.uds.log.bean.pbv26.OriginDataBean;
...
//    }
    ...
    public byte[] genPbV1Data(String json) throws Exception {
        ...
        logDataBuilder.setVersion("v2.6");
